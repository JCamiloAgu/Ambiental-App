...
object Data {
    fun getAnswers(): ArrayList<MutableList<Answers>> {
        ...
        val answersQuestion1: MutableList<Answers> = mutableListOf(answer1_1, answer1_2, answer1_3, answer1_4)
        ...
        val answersQuestion2: MutableList<Answers> = mutableListOf(answer2_1, answer2_2, answer2_3, answer2_4)
        ...
        val answersQuestion3: MutableList<Answers> = mutableListOf(answer3_1, answer3_2, answer3_3, answer3_4)
